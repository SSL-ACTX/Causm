...
pub const STD_ENCODING_TYPES: &str =
    include_str!("../csm/std/encoding/types.csm");
pub const STD_ENCODING_UTF8: &str = include_str!("../csm/std/encoding/utf8.csm");
pub const STD_ENCODING_BASE64: &str =
    include_str!("../csm/std/encoding/base64.csm");
pub const STD_ENCODING_BINARY: &str =
    include_str!("../csm/std/encoding/binary.csm");
...
pub fn get_module(path: &str) -> Option<&'static str> {
    match path {
        ...
        "std::encoding::base64" | "std/encoding/base64" => {
            Some(STD_ENCODING_BASE64)
        }
        "std::encoding::binary" | "std/encoding/binary" => {
            Some(STD_ENCODING_BINARY)
        }
