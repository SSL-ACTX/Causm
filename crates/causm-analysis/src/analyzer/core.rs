...
impl EntropicAnalyzer {
    ...
    pub fn register_intrinsics(&mut self) {
        ...
        let collection_intrinsics = vec![
            ...
            ("__sync_atomic_store_int", vec![Type::Unknown, Type::Integer],                      Type::Unknown),
            ("__sync_atomic_fetch_add", vec![Type::Unknown, Type::Integer],                      Type::Unknown),
            ("__sync_atomic_cas_int",   vec![Type::Unknown, Type::Integer, Type::Integer],       Type::Unknown),
            ("__sync_atomic_new_bool",  vec![Type::Bool],                                        Type::Unknown),
            ("__sync_atomic_load_bool", vec![Type::Unknown],                                     Type::Bool),
            ("__sync_atomic_store_bool",vec![Type::Unknown, Type::Bool],                         Type::Unknown),
            ("__sync_atomic_cas_bool",  vec![Type::Unknown, Type::Bool, Type::Bool],             Type::Unknown),
            ("__sync_mutex_new",        vec![],                                                  Type::Unknown),
            ("__sync_mutex_try_lock",   vec![Type::Unknown, Type::String],                       Type::Unknown),
            ...
            ("__sync_channel_send",     vec![Type::Unknown, Type::Integer],                      Type::Unknown),
