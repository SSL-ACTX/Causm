...
Currently, Causm timelines primarily exchange state during formal `merge` operations. **Entropic Channels** facilitate mid-execution communication between split timelines while maintaining strict single-ownership and temporal determinism.
