...
This document specifies the formal behavior of conditional branching and structural pattern matching within the Causm, including the protocols for speculative execution and entropic state reconciliation.
